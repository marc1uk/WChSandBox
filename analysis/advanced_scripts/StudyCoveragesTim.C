...
//  TString genfilename("../../generatorcardfile.root");
  TString filename("/vols/t2k03/hyperk/output/sim/genie/genie/FullEvent_antinu_0.root");
  TString genfilename("/vols/t2k03/hyperk/output/sim/genie/genie/generatorcardfile_antinu_0.root");
