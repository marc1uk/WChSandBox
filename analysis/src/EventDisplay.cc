...
EventDisplay::EventDisplay(TString iname)
{
  _isweighted=false;
...
void EventDisplay::SetHits(vector< vector<double> > ihits)
{
  theHits.clear();
...
void EventDisplay::SetAzimuth(vector< vector<double> > tresid, vector< vector<double> > azimuth, vector< vector<double> > tracktheta){
  _tresid = tresid;
  _azimuth = azimuth;
  _ttheta = tracktheta;
  _setazimuth = true;
...
void EventDisplay::SetGeometry(int type, double d1, double d2, double d3, double clearance)
{
...
void EventDisplay::SetPMTGeometry(int pmttype, double diameter, double coverage, bool spatialresolving)
{
...
void EventDisplay::SetPlots(TH1D* trD,TH1D* tpD,TH1D* ttD)
{
...
void EventDisplay::SetTrueTrackParams(vector<double> tparams)
{
  truetrack=tparams;
...
void EventDisplay::InitializeStyle(){
...
TCanvas* EventDisplay::MakeCanvas(int ctype, TString namestring, TH2D* &iwcDisplay){
...
void EventDisplay::SavePlotsBarrel(string savename, bool savecanvas, double lowt, double hight)
{
...
void EventDisplay::SavePlotsCube(string savename, bool savecanvas, double lowt, double hight)
{
...
void EventDisplay::doAzimuthalPlots(int tbins, int phibins, string savename, double lowt, double hight){
