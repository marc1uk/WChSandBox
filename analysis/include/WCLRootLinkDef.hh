...
#pragma link C++ class WCSimWaterModel+;
#pragma link C++ class WCSimParameters+;
#pragma link C++ class WCSimIsoChronTransform+;
#pragma link C++ class WCSimVertexGeometry+;
#pragma link C++ class RasterizeCircle+;
#pragma link C++ class WCSimIsochron+;
#pragma link C++ class WChRecoLite+;
...
#pragma link C++ class WCSimTrueLight+;
#pragma link C++ class WCSimTruePart+;
#pragma link C++ class WCSimTrueCapture+;
#pragma link C++ class WCSimTrueLightCluster+;
