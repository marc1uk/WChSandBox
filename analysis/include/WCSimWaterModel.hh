#ifndef WCSIMWATERMODEL_HH
#define WCSIMWATERMODEL_HH
...
class WCSimWaterModel : public TObject {

  public:
    static WCSimWaterModel* Instance();
    //static WCSimWaterModel* Instance(Int_t op1, Int_t op2, Int_t op3); //op1 is absorption length, op2 is qe, op3 is index; And value=0 is default table, 1 is input table, 2 is parametera
    void Reset();
    ...
    Double_t VgWCSim(Double_t flmda);
  ...
  private:
    //WCSimWaterModel(Int_t op1, Int_t op2, Int_t op3);
    WCSimWaterModel();
    ~WCSimWaterModel();
