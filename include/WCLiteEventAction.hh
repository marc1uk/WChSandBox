...
class WCLiteRunAction;
class WCLitePrimaryGeneratorAction;
class G4Event;
// *******************************
// End Added for WCSim PMT support
// ===============================
...
{
  public:
    WCLiteEventAction(WCLiteRunAction*, WCLiteDetectorConstruction*, WCLitePrimaryGeneratorAction*);
    // arguments introduced for WCSim PMT support
   ~WCLiteEventAction();
...
//  G4int *part_mrddetected;
  ...
  private:
  WCLiteRunAction* runAction;
  WCLitePrimaryGeneratorAction* generatorAction;
  WCLiteDetectorConstruction*   detectorConstructor;
  WCSimWCDAQMessenger* DAQMessenger;
  void CreateDAQInstances(); //TODO make this private
  //***************************
  // End Support for WCSim PMTs
  // ==========================
