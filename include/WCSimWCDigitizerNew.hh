...
public:
  ...
  WCSimWCDigitizerBase(G4String name, WCLiteDetectorConstruction*, WCSimWCDAQMessenger*, DigitizerType_t);
...
protected:
  ...
  WCLiteDetectorConstruction* myDetector; ///< Get the geometry information
...
public:
  ...
  WCSimWCDigitizerSKI(G4String name, WCLiteDetectorConstruction*, WCSimWCDAQMessenger*);
  ~WCSimWCDigitizerSKI();
