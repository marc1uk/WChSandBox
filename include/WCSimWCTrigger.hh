...
public:
  ...
  WCSimWCTriggerBase(G4String name, WCLiteDetectorConstruction*, WCSimWCDAQMessenger*);
  ...
  ///DEPRECATED function used in old class (WCSimWCDigitizer), and called in WCLiteEventAction
...
protected:
  ...
  WCLiteDetectorConstruction* myDetector;   ///< Know about the detector, so can add appropriate PMT time smearing
...
public:
  ...
  WCSimWCTriggerNDigits(G4String name, WCLiteDetectorConstruction*, WCSimWCDAQMessenger*);
...
public:
  ...
  WCSimWCTriggerNDigits2(G4String name, WCLiteDetectorConstruction*, WCSimWCDAQMessenger*);
