 ...
 * put here (in WCLiteDetectorConstruction) so both pieces of 
 * code would have access to it.
 *
 * Sourcefile for the WCLiteDetectorConstruction class
 *
 ***********************************************************/


G4float WCLiteDetectorConstruction::GetPMTQE(G4String CollectionName, G4float PhotonWavelength, G4int flag, G4float low_wl, G4float high_wl, G4float ratio){
  // XQ  08/17/10
