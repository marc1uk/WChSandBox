...
faccPMTSD::faccPMTSD(G4String name)
  : G4VSensitiveDetector(name),fPMTHitCollection(0)
{
  collectionName.insert("faccpmtHitCollection");
}
...
void faccPMTSD::Initialize(G4HCofThisEvent* hitsCE){
  fPMTHitCollection = new faccPMThitsCollection(SensitiveDetectorName,collectionName[0]);
  ...
  nhit=0;
  G4cout<<"Initializing FACC/PMT sensitive detectors."<<G4endl;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4bool faccPMTSD::ProcessHits(G4Step* ,G4TouchableHistory* ){
  return false;	
  G4cout<<"rejected hit on Veto."<<G4endl;
...
G4bool faccPMTSD::ProcessHits_PhotonHit(const G4Step* aStep, G4TouchableHistory* ){
  ...
  // also only want to accept photon hits on one face of the paddle, representing the WLS fibre ribbon. 
  ...
  if(physVol->GetName()!="vetoSurface_phys"){ return false;}
...
/*  //Find the correct hit collection
  ...
  if(hit==NULL){//this pmt wasnt previously hit in this event
    hit = new faccPMThit(); //so create new hit
...
// --------------------------------------------------------
     faccPMThit* hit = new faccPMThit(aStep); // create new hit
     hit->SetHitID(nhit);
     nhit++;
     hit->SetPMTNumber(pmtNumber);
     hit->SetPMTPhysVol(physVol);
...
void faccPMTSD::EndOfEvent(G4HCofThisEvent* ) {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void faccPMTSD::clear() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void faccPMTSD::DrawAll() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void faccPMTSD::PrintAll() {}
