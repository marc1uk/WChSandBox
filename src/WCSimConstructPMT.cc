...
WCLiteDetectorConstruction::PMTMap_t WCLiteDetectorConstruction::PMTLogicalVolumes;

G4LogicalVolume* WCLiteDetectorConstruction::ConstructPMT(G4String PMTName, G4String CollectionName)
{
