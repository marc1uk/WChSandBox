...
G4Allocator<faccPMThit> faccPMThitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

//faccPMThit::faccPMThit() : fPmtNumber(-1),fPhysVol(0),fDrawit(false) {} // not used. fPhotons(0),

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

faccPMThit::faccPMThit(const G4Step* aStep){
	//G4cout<<"FACC Photon Hit Step constructor"<<G4endl;
...
faccPMThit::~faccPMThit() {} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

faccPMThit::faccPMThit(const faccPMThit &right) : G4VHit()
{
  fHitID=right.fHitID;
...
const faccPMThit& faccPMThit::operator=(const faccPMThit &right){
  fHitID=right.fHitID;
  fTrackID=right.fTrackID;
  fParentID=right.fParentID;
  fPmtNumber=right.fPmtNumber;
...
G4int faccPMThit::operator==(const faccPMThit &right) const{
  return (fHitID==right.fHitID);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void faccPMThit::Draw(){
