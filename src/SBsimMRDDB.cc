...
////////////////////////
{
  ...
  SetModuleInfo((char*)"../../SciBooNE/sub/mrdmodule.txt");
  SetPositionInfo((char*)"../../SciBooNE/sub/mrdposition.txt");
  SetAlignmentInfo("../../SciBooNE/sub/mrd-align.txt");
  SetNoiseHitInfo((char*)"../../SciBooNE/sub/mrdnoisehit.txt");
}
