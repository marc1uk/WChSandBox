...
void WCLitePhysicsList::ConstructParticle()
{
...
void WCLitePhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
...
void WCLitePhysicsList::ConstructEM()
{
...
void WCLitePhysicsList::ConstructlArStepLimiter(){
...
void WCLitePhysicsList::ConstructOp(){
...
//   theRayleighScatteringProcess->DumpPhysicsTable();
  ...
  theScintillationProcess->SetScintillationYieldFactor(0.26);

  //Birks constant
  G4EmSaturation* emSaturation = G4LossTableManager::Instance()->EmSaturation();
  theScintillationProcess->AddSaturation(emSaturation);

  // The SetModel method is removed in Geant 4.9.6 FDL
...
void WCLitePhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void WCLitePhysicsList::ConstructHad() 
{
...
// Bertini = Bertini intra-nuclear cascade model
// Binary  = Binary intra-nuclear cascade model
void WCLitePhysicsList::SetSecondaryHad(G4String hadval)
{
