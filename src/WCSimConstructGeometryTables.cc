...
void WCLiteDetectorConstruction::PrintGeometryTree
...
void WCLiteDetectorConstruction::GetWCGeom
(G4VPhysicalVolume* aPV ,int aDepth, int /*replicaNo*/, 
 const G4Transform3D& aTransform) 
{
...
void WCLiteDetectorConstruction::DescribeAndRegisterPMT(G4VPhysicalVolume* aPV ,int aDepth, int replicaNo,
                                                       const G4Transform3D& aTransform) 
{
...
void WCLiteDetectorConstruction::DumpGeometryTableToFile()
{
  // Open a file
...
void WCLiteDetectorConstruction::TraverseReplicas
...
void WCLiteDetectorConstruction::DescribeAndDescendGeometry
(G4VPhysicalVolume* aPV ,int aDepth, int replicaNo, 
...
G4double WCLiteDetectorConstruction::GetGeo_Dm(G4int i){
  if (i>=0&&i<=2){
    return WCCylInfo[i];
  }else if(i==3){
    return innerradius;
